...
import NotificationsDrawer from "./notifications-popover";
...
const languages = {
  ...
  uz: "/static/icons/flag_uz.png",
  ru: "/static/icons/flag_ru.png",
};
  ...
  return (
    <>
      ...
      >
        ...
        >
          <img alt="language" src={languages[i18n.language]} />
        </Box>
      </IconButton>
      <LanguagePopover
...
const ContactsButton = () => {
  ...
  return (
    <>
      <Tooltip title="Onlayn foydalanuvchilar">
        <IconButton
          onClick={handleOpenPopover}
          sx={{ ml: 1, borderRadius: "50%" }}
          ref={anchorRef}
