...
import OperatorsRow from "../TableRows/OperatorsRow";
import { searchOperatorList } from "redux-store/admin/operators/operator.slice";
...
const SearchOperators = () => {
  ...
  const isLoading = useSelector((state) => state.operators.searchLoading);
  const list = useSelector((state) => state?.operators?.searchList);
